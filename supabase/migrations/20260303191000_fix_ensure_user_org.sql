-- Fix: organizations table has no owner_id column (shared with MeowCRM)
...
BEGIN
  ...
  -- Create a new organization (no owner_id column in shared table)
  INSERT INTO organizations (name)
  VALUES (COALESCE(NULLIF(p_name, ''), split_part(p_email, '@', 1)) || ' 的團隊')
